...
class TestCampaignExecutor:
    ...
    async def test_progress_campaign_failure(self, campaign_executor, campaign_manager, monkeypatch):
        ...
        # Mock the progress_experiment method to raise an EosExperimentExecutionError
    ...
    async def test_campaign_resuming(
        ...
        new_execution_parameters = CampaignExecutionParameters(
            max_experiments=MAX_EXPERIMENTS, do_optimization=DO_OPTIMIZATION, resume=True
        )
